import {
    CY_ALT_INGREDIENT_INFO_LINE_NAME, CY_ALT_INGREDIENT_LINE,
    CY_ALT_INGREDIENT_LINE_REMOVE_BUTTON,
    CY_ALT_INGREDIENT_LINE_SEARCH_BUTTON,
    CY_FOOD_API_PATH, CY_FOOD_PATH, CY_INGREDIENT_INFO_LINE, CY_INGREDIENT_INFO_LINE_NAME,
    CY_INGREDIENT_INFO_LINE_NF_AMOUNT, CY_INGREDIENT_INFO_LINE_NF_TYPE,
