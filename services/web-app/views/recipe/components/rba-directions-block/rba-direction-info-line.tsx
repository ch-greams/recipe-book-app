...
const RbaDirectionInfoLine: React.FC<Props> = ({ isReadOnly, index, direction }) => {
...
RbaDirectionInfoLine.displayName = "RbaDirectionInfoLine";

export default RbaDirectionInfoLine;
