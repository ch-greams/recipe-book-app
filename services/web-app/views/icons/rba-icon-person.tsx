...
const RbaIconPerson: React.FC<IconProps> = ({ width, height, color }) => {
    return (
        <svg viewBox={"0 0 512 512"} width={width} height={height} fill={color} stroke={color}>
...
RbaIconPerson.displayName = "RbaIconPerson";

export default RbaIconPerson;
