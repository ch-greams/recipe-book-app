...
import { UpdateNutritionFactAction } from "@client/store/food/types";

import { NutritionFact } from "./NutritionFactsBlock";

import styles from "./NutritionFactsBlockLine.scss";
